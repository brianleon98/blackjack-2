...
//ganancias
const ganancias = document.querySelectorAll('a');  // almaceno en una constante el elemento a del documento html
const premioMayor = 1000;
const mitadPremio = 750;
const empate = 500;
...
//y si los puntos del segundo jugador son mayores alos del primero y si tambien son mayores alos de la computadora mostrar segundo y tercer jugador ganan
        ...
        alert(`${players[1]} Y ${players[2]} gana `)      
...
//validacion de ganancias

    if (puntosMinimos === 21 ) {
        var valor = document.querySelector('#A');
            var valor1 = valor.innerText;
            var resultado = parseInt(valor1) + premioMayor;
            ganancias[0].innerText = resultado

    }else if (puntosMinimos2 === 21  ) {
         let valor = document.querySelector('#B');
            var valor1 = valor.innerText;
            var resultado = parseInt(valor1) + premioMayor;
            ganancias[1].innerText = resultado

    }else if (puntosMinimos3 === 21) {
         let valor = document.querySelector('#C');
            var valor1 = valor.innerText;
            var resultado = parseInt(valor1) + premioMayor;
            ganancias[2].innerText = resultado

    }else if (puntosComputadora === 21 ) {
            let valor = document.querySelector('#D');
            var valor1 = valor.innerText;
            var resultado = parseInt(valor1) + premioMayor;
            console.log(resultado)
            ganancias[3].innerText = resultado

    }else if (puntosMinimos < 21 && puntosMinimos > puntosMinimos2 && puntosMinimos > puntosMinimos3 && puntosMinimos > puntosComputadora) {
            let valor = document.querySelector('#A');
            var valor1 = valor.innerText;
            var resultado = parseInt(valor1) + mitadPremio;
            console.log(resultado)
            ganancias[0].innerText = resultado
    
    }else if (puntosMinimos2 < 21 && puntosMinimos2 > puntosMinimos && puntosMinimos2 > puntosMinimos3 && puntosMinimos2 > puntosComputadora) {
            let valor = document.querySelector('#B');
            var valor1 = valor.innerText;
            var resultado = parseInt(valor1) + mitadPremio;
           // console.log(resultado)
    ...
    }else if (puntosMinimos3 < 21 && puntosMinimos3 > puntosMinimos && puntosMinimos3 > puntosMinimos2 && puntosMinimos3 > puntosComputadora) {
            var valor = document.querySelector('#C');
            var valor1 = valor.innerText;
            var resultado = parseInt(valor1) + mitadPremio;
            console.log(resultado)
            ganancias[2].innerText = resultado

    }else if (puntosComputadora < 21 && puntosComputadora > puntosMinimos && puntosComputadora > puntosMinimos2 && puntosComputadora > puntosMinimos3) {
            var valor = document.querySelector('#D');
            var valor1 = valor.innerText;
            var resultado = parseInt(valor1) + mitadPremio;
            console.log(resultado)
            ganancias[3].innerText = resultado
            ...
            var valor1 = document.querySelector('#A');
            let valor2 = document.querySelector('#B');

            var valor1 = valor1.innerText;
            var resultado1 = parseInt(valor1) + empate;
            console.log(resultado1)
            ganancias[0].innerText = resultado1

            var valo = valor2.innerText;
            var resultado2 = parseInt(valo) + empate;
            console.log(resultado2)
            ganancias[1].innerText = resultado2
   
    }else if (puntosMinimos === puntosMinimos3 && puntosMinimos > puntosMinimos2 && puntosMinimos > puntosComputadora) {
            var valor1 = document.querySelector('#A');
            let valor3 = document.querySelector('#C');
            ...
            var valo = valor3.innerText;
            var resultado2 = parseInt(valo) + empate;
            console.log(resultado2)
            ganancias[2].innerText = resultado2

    }else if (puntosMinimos === puntosComputadora && puntosMinimos > puntosMinimos2 && puntosMinimos > puntosMinimos3) {
            var valor1 = document.querySelector('#A');
            let valor4 = document.querySelector('#D');
            ...
            var valo = valor4.innerText;
            var resultado2 = parseInt(valo) + empate;
            console.log(resultado2)
            ganancias[3].innerText = resultado2


    }else if (puntosMinimos2 === puntosComputadora && puntosMinimos2 > puntosMinimos && puntosMinimos2 > puntosMinimos3) {
            var valor1 = document.querySelector('#B');
            let valor4 = document.querySelector('#D');

            var valor1 = valor1.innerText;
            var resultado1 = parseInt(valor1) + empate;
            console.log(resultado1)
            ganancias[1].innerText = resultado1
    ...
    }else if (puntosMinimos3 === puntosMinimos2 && puntosMinimos3 > puntosMinimos && puntosMinimos3 > puntosComputadora) {
            var valor1 = document.querySelector('#B');
            let valor4 = document.querySelector('#C');
    ...
    } else if (puntosMinimos3 === puntosComputadora && puntosMinimos3 > puntosMinimos && puntosMinimos3 > puntosMinimos2) {
            var valor1 = document.querySelector('#C');
            let valor4 = document.querySelector('#D');

            var valor1 = valor1.innerText;
            var resultado1 = parseInt(valor1) + empate;
            console.log(resultado1)
            ganancias[2].innerText = resultado1
    ...
    }else if (puntosMinimos === puntosMinimos2 && puntosMinimos === puntosMinimos3 && puntosComputadora >= 22) {
            var valor1 = document.querySelector('#A');
            var valor2 = document.querySelector('#B');
            var valor3 = document.querySelector('#C');
            ...
            var val = valor3.innerText;
            var resultado3 = parseInt(val) + empate;
            console.log(resultado3)
            ganancias[2].innerText = resultado3 


    }else if (puntosMinimos2 === puntosMinimos3 && puntosMinimos2 === puntosComputadora && puntosMinimos2 > puntosMinimos) {
            var valor2 = document.querySelector('#B');
            var valor3 = document.querySelector('#C');
            var valor4 = document.querySelector('#D');

            var valor2 = valor2.innerText;
            var resultado2 = parseInt(valor2) + empate;
            console.log(resultado2)
            ganancias[1].innerText = resultado2;

            var valo = valor3.innerText;
            var resultado3 = parseInt(valo) + empate;
            console.log(resultado3)
            ganancias[2].innerText = resultado3   

            var val = valor4.innerText;
            var resultado4 = parseInt(val) + empate;
            console.log(resultado4)
            ganancias[3].innerText = resultado4 ;
